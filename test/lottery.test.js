...
contract('Lottery', function([deployer, user1, user2]){
    ...
    describe('Distribute', function () {
        describe('When the answer is checkable', function() {
            it('should give the user the pot when the answer matches', async () => {
                // 두 글자 다 맞았을 때
                await lottery.setAnswerForTest('0xabb45be19439ecdfdf0fe1e32dc8c40765426e21f8ce1d266a8b6630196cf8fa', {from:deployer})
    ...
    describe('isMatch', function () {
        let blockHash = '0xabb45be19439ecdfdf0fe1e32dc8c40765426e21f8ce1d266a8b6630196cf8fa'
        ...
        it('should be BettingResult.Drawl when two characters match', async () => {
